...
import com.ulusoyapps.localmovehandler.LocalPlayerMoveHandler
import com.ulusoyapps.tictactoe.datasource.datasources.playermove.PlayerMoveDataSource
import dagger.Binds
import dagger.Module

@Module
abstract class LocalMoveHandlerModule {
    // Use @Binds to tell Dagger which implementation it needs to use when providing an interface.
    @Binds
    abstract fun providePlayerMoveDataSource(playerMoveDataSource: LocalPlayerMoveHandler): PlayerMoveDataSource
}
